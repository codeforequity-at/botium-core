...
module.exports = class LogicHookUtils {
  ...
  _setDefaultAsserters () {
    ...
    this.asserters['ENTITIES'] = new EntitiesAsserter(this.buildScriptContext, this.caps)
    this.asserters['ENTITY_VALUES'] = new EntityValuesAsserter(this.buildScriptContext, this.caps)
    this.asserters['INTENT'] = new IntentAsserter(this.buildScriptContext, this.caps)
    this.asserters['INTENT_CONFIDENCE'] = new IntentConfidenceAsserter(this.buildScriptContext, this.caps)
