...
describe('tree.buildconversationtreeview', function () {
  it('should build shared convo node on messageText', async function () {
    ...
    assert.equal(tree[0].convoNodes[0].utteranceCount, 1)
    assert.equal(tree[0].convoNodes[0].utteranceSamples.length, 1)
  ...
  it('should provide utterance samples', async function () {
    ...
    assert.equal(tree[1].convoNodes[0].utteranceCount, 1)
    assert.equal(tree[1].convoNodes[0].utteranceSamples.length, 1)
