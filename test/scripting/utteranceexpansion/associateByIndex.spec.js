...
describe('scripting.utteranceexpansion.associateByIndex', function () {
  it('should associate utterances by index', async function () {
    ...
    scriptingProvider.AddUtterances({
      name: 'UTT_HELLO',
      utterances: ['UTT_HELLO_SAMPLE_1', 'UTT_HELLO_SAMPLE_2']
    })
    scriptingProvider.AddUtterances({
      name: 'UTT_BODY',
    ...
    scriptingProvider.AddUtterances({
      name: 'UTT_GOODBYE',
      utterances: ['UTT_GOODBYE_SAMPLE_1', 'UTT_GOODBYE_SAMPLE_2','UTT_GOODBYE_SAMPLE_3']
    })
    ...
    assert.equal(scriptingProvider.convos[2].header.name, 'test convo/UTT_HELLO-L2/UTT_BODY-L1/UTT_GOODBYE-L3')
  ...
  it('should associate media by index', async function () {
    ...
    assert.deepEqual(scriptingProvider.convos[1].conversation.length, 6)
    assert.equal(scriptingProvider.convos[2].header.name, 'test convo/MEDIA-L2/MEDIA-L1/MEDIA-L3')
    assert.deepEqual(scriptingProvider.convos[2].conversation.length, 6)
  })
  it('should associate utterance and media by index', async function () {
    ...
    assert.equal(scriptingProvider.convos[2].header.name, 'test convo/UTT_HELLO-L2/UTT_BODY-L1/UTT_GOODBYE-L3/MEDIA-L2/MEDIA-L1/MEDIA-L3')
