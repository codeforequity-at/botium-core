...
describe('scripting.asserters.textContainsAnyAsserter', function () {
  ...
  it('nok, base', async function () {
    ...
    try {
      ...
      assert.equal(err.message, 'text_contains_any_nok_base/Line 2: assertion error - Line 2: Expected any in response "word3"')
    }
  })
  ...
  it('nok, more words', async function () {
    ...
    try {
      ...
      assert.equal(err.message, 'text_contains_any_nok_more_words/Line 2: assertion error - Line 2: Expected any in response "word3,word4,word5"')
    }
  })
  ...
  it('nok, utterances', async function () {
    ...
    try {
      ...
      assert.equal(err.message, 'text_contains_any_nok_utterances/Line 2: assertion error - Line 2: Expected any in response "word3,word4,hi,hello!"')
    }
  })
  ...
  it('nok, ignore case', async function () {
    ...
    try {
      ...
      assert.equal(err.message, 'text_contains_any_nok_ignore_case/Line 2: assertion error - Line 2: Expected any in response "Word3"')
    }
  })
  ...
  it('nok, negate', async function () {
    ...
    try {
      ...
      assert.equal(err.message, 'text_contains_any_nok_negate/Line 2: assertion error - Line 2: Not expected any in response "word2"')
    }
  })
