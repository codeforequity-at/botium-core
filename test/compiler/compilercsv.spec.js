...
describe('compiler.compilercsv', function () {
  ...
  describe('Sender mode, 1 col', function () {
    ...
    it('should read basic case', async function () {
      const scriptBuffer = fs.readFileSync(path.resolve(__dirname, 'convos', 'convos_sender_just_text_no_header'))
      const context = buildContext()
    ...
    it('should read basic case', async function () {
      const scriptBuffer = fs.readFileSync(path.resolve(__dirname, 'convos', 'convos_sender_just_text_no_header_4cols'))
      const context = buildContext()
