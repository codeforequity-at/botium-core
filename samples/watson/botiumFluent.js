...
driver.BuildFluent()
  .Start()
  .UserSaysText('start')
  .WaitBotSaysText(5000, (text) => assert('Hi. It looks like a nice drive today. What would you like me to do?', text))
  .UserSaysText('turn on the lights please')
  .WaitBotSaysText(5000, (text) => assert('I\'ll turn on the lights for you.', text))
  .UserSaysText('play some jazz music')
  .WaitBotSaysText(5000, (text) => assert('Great choice! Playing some jazz for you.', text))
  .Stop()
  .Clean()
  .Exec()
  .then(() => {
